...
import CryptoInfoSearch from "../components/CryptoInfoSearch.jsx";
...
export const skillsData = [
    { id: "Rust_skill", content: "Rust", type: "System Programming Language", years: 4, level: 5, description:"Features and APIs with async frameworks, developed with a focus on memory safety, ownership, & robust error handling"},
    { id: "JavaScript_skill", content: "JavaScript", type: "Scripting Language", years: 8, level: 5, description:"Build interactive web applications harnessing the versatility of scripting for enhanced user & dev experiences"},
    { id: "React_skill", content: "React", type: "Frontend JS Library/Framework", years: 6, level: 5, description:"Streamlined complex UIs & native-looking mobile apps with React's efficient, functional component-based approach"},
    { id: "TypeScript_skill", content: "TypeScript", type: "Programming Language", years: 3, level: 3, description:"Ensured code quality and maintainability with TypeScript's optional static typing"},
    { id: "HTML5_skill", content: "HTML5", type: "Markup Language", years: 7, level: 4 , description:"Mastered web page structure and styling, bringing designs to life with modern standards"},
    { id: "CSS3_skill", content: "CSS3", type: "Style Sheet Language", years: 7, level: 4, description:"Mastered web page structure and styling, bringing designs to life with modern standards"},
    { id: "node_skill", content: "NodeJS", type: "JS Runtime Environment", years: 5, level: 4, description:"Empowered full-stack development, seamlessly bridging frontend and backend with JavaScript"},
    { id: "Express_skill", content: "ExpressJS", type: "JS Backend Framework", years: 5, level: 4, description:"Empowered full-stack development, seamlessly bridging frontend and backend with JavaScript"},
    { id: "SQL_skill", content: "SQL", type: "Database Query Language", years: 10, level: 6, description:"Navigated both relational and non-relational data realms, ensuring efficient data storage and retrieval"},
    { id: "mongo_skill", content: "MongoDB", type: "NoSQL Database", years: 4, level: 4, description:"Navigated both relational and non-relational data realms, ensuring efficient data storage and retrieval"},
    { id: "Blockchain_skill", content: "Blockchain", type: "Distributed Ledger Technology", years: 4, level: 6, description:"Navigated the decentralized world, crafting solutions that leverage transparency, security and immutability"},
    { id: "Solidity_skill", content: "Solidity", type: "Programming language", years: 3, level: 4, description:"Unlocked blockchain potential, crafting smart contracts and dApps that interact with decentralized networks"},
    { id: "Web3_skill", content: "Web3", type: "Blockchain Web Tech API", years: 4, level: 4, description:"Unlocked blockchain potential, crafting smart contracts and dApps that interact with decentralized networks"},
    { id: "Ethereum_skill", content: "Ethereum", type: "Blockchain Platform", years: 4, level: 3, description:"Explored leading blockchain platforms, understanding their strengths and trade-offs for various use cases"},
    { id: "Solana_skill", content: "Solana", type: "Blockchain Platform", years: 3, level: 4, description:"Explored leading blockchain platforms, understanding their strengths and trade-offs for various use cases"},
    { id: "Git_skill", content: "Git", type: "Version Control", years: 8, level: 4, description:"Collaborated effectively and managed dependencies, ensuring smooth project development and version control"},
    { id: "NPM_skill", content: "NPM", type: "Package Manager", years: 8, level: 5, description:"Collaborated effectively and managed dependencies, ensuring smooth project development and version control"},
    { id: "Webpack_skill", content: "Webpack", type: "Module Bundler", years: 6, level: 4, description:"Conquered complex module bundling, optimizing JavaScript applications for performance"},
    { id: "IPFS_skill", content: "IPFS", type: "Distributed File System", years: 3, level: 4, description:"Championed decentralized storage, building applications that leverage its censorship resistance and distribution"},
    { id: "Flutter_skill", content: "Flutter", type: "UI SDK", years: 2, level: 2, description:"Expanded reach across platforms, creating native-looking mobile apps with Dart proficiency"},
    { id: "Docker_skill", content: "Docker", type: "Deployment", years: 5, level: 3, description:"Streamlined deployments, packaging applications for consistent and portable environments"},
...
// Here goes the about me data split in paragraphs
 ...
 export const techIcons = {
  ...
  Solana: (
    <svg width="40" height="40" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg"><g id="SVGRepo_bgCarrier" strokeWidth="0"></g><g id="SVGRepo_tracerCarrier" strokeLinecap="round" strokeLinejoin="round"></g><g id="SVGRepo_iconCarrier"> <path fillRule="evenodd" clipRule="evenodd" d="M7.08398 5.22265C7.17671 5.08355 7.33282 5 7.5 5H18.5C18.6844 5 18.8538 5.10149 18.9408 5.26407C19.0278 5.42665 19.0183 5.62392 18.916 5.77735L16.916 8.77735C16.8233 8.91645 16.6672 9 16.5 9H5.5C5.3156 9 5.14617 8.89851 5.05916 8.73593C4.97215 8.57335 4.98169 8.37608 5.08398 8.22265L7.08398 5.22265ZM7.76759 6L6.43426 8H16.2324L17.5657 6H7.76759Z" fill="#47495F"></path> <path fillRule="evenodd" clipRule="evenodd" d="M7.08398 15.2226C7.17671 15.0836 7.33282 15 7.5 15H18.5C18.6844 15 18.8538 15.1015 18.9408 15.2641C19.0278 15.4267 19.0183 15.6239 18.916 15.7774L16.916 18.7774C16.8233 18.9164 16.6672 19 16.5 19H5.5C5.3156 19 5.14617 18.8985 5.05916 18.7359C4.97215 18.5734 4.98169 18.3761 5.08398 18.2226L7.08398 15.2226ZM7.76759 16L6.43426 18H16.2324L17.5657 16H7.76759Z" fill="#47495F"></path> <path fillRule="evenodd" clipRule="evenodd" d="M7.08398 13.7774C7.17671 13.9164 7.33282 14 7.5 14H18.5C18.6844 14 18.8538 13.8985 18.9408 13.7359C19.0278 13.5733 19.0183 13.3761 18.916 13.2226L16.916 10.2226C16.8233 10.0836 16.6672 10 16.5 10H5.5C5.3156 10 5.14617 10.1015 5.05916 10.2641C4.97215 10.4267 4.98169 10.6239 5.08398 10.7774L7.08398 13.7774ZM7.76759 13L6.43426 11H16.2324L17.5657 13H7.76759Z" fill="#47495F"></path> </g></svg>
  ),
  Git: (
    ...
    projects: [
      {
        ...
        srcScreen: require("../images/SC_3_209.webm"),
      },
      {
      ...
      {
        title: "API Integration Interaction",
        srcScreen: "",
